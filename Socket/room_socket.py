from Socket.socket import socketio,emit,join_room
...
def join_sock(data):
    ...
    socket_class.update_room_player_count(room_name, "님이 참가 하셨습니다.", room_data_manager._data_store[room_name]['user'][session_id]['username'])
    try:
