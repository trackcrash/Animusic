...
function manual5_make() {
    ...
    tutorial_Timeinputlist.forEach(input => {
        input.addEventListener('input', (e) => {
            ...
            if (tutorial_Timeinputlist[0].value) {tutorial_startTime += parseFloat(tutorial_Timeinputlist[0].value) * 3600}
            if (tutorial_Timeinputlist[1].value) {tutorial_startTime += parseFloat(tutorial_Timeinputlist[1].value) * 60}
            if (tutorial_Timeinputlist[2].value) {tutorial_startTime += parseFloat(tutorial_Timeinputlist[2].value)}
            if (tutorial_Timeinputlist[3].value) {tutorial_startTime += parseFloat('0.' + String(tutorial_Timeinputlist[3].value))}

            if (tutorial_Timeinputlist[4].value) {tutorial_endTime += parseFloat(tutorial_Timeinputlist[4].value) * 3600}
            if (tutorial_Timeinputlist[5].value) {tutorial_endTime += parseFloat(tutorial_Timeinputlist[5].value) * 60}
            if (tutorial_Timeinputlist[6].value) {tutorial_endTime += parseFloat(tutorial_Timeinputlist[6].value)}
            ...
            if (tutorial_startTime > 0) {
                ...
                if (s_time_s || s_time_ms) {tutorial_startText += (s_time_s + s_time_ms) + '초';}
            }
            ...
            if (tutorial_endTime > 0) {
                ...
                if (e_time_s || e_time_ms) {tutorial_endText += (e_time_s + e_time_ms) + '초';}
            }
